...
-- Create enum for project domains
CREATE TYPE public.project_domain AS ENUM ('web', 'android', 'machine-learning', 'data-science', 'flutter', 'saas');
...
FOR EACH ROW EXECUTE FUNCTION public.update_project_upvotes_count();
